...
Currently I am Using on Fxtec Pro1x. V_2.1 boots black (but boot) touch works. I am using kernel 6.18-rc6 debian.
...
minor fixes touch video works will begin to test modem etc.

patches/apply_patches.sh # test patches  
patches/TOUCH_MOUSE_Boot-wtf-6.18.patch  
