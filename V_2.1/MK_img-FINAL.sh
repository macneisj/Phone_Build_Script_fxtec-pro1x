...
KERNEL_IMAGE_PATH="$ROOT_SCRIPT_DIR/linux-6.18/arch/arm64/boot/Image.gz"
DTB_SOURCE_FILE="$ROOT_SCRIPT_DIR/linux-6.18/arch/arm64/boot/dts/qcom/sm6115-fxtec-pro1x.dtb"
CONCATENATED_KERNEL_DTB="$ROOT_SCRIPT_DIR/.Image.gz-dtb"
#ROOTFS_DIR="pro1x-fluxbox-rootfs"
ROOTFS_DIR="pro1x-fluxbox-rootfs-6.18"
...
#sudo chroot "$ROOTFS_DIR" apt install -y onboard pavucontrol
#firmware-iwlwifi firmware-qcom-soc firmware-linux qcom-phone-utils firmware-qcom-media firmware-qcom*
#firmware-iwlwifi firmware-qcom-soc firmware-linux qcom-phone-utils
...
# earlycon=msm_geni_serial,0x4a90000 console=ttyMSM0,115200n8 console=tty0 loglevel=7 modprobe.blacklist=msm_drm drm.debug=0x1e
...
#CMDLINE="root=/dev/sda13 rootwait rw"
CMDLINE="root=/dev/sda13 rootwait rw earlycon=msm_geni_serial,0x4a90000 console=ttyMSM0,115200n8 console=tty0 loglevel=7"
